...
<div class="all_comp">
    <div id="tanks">
        <div class="text">Tank-A : <span id="variable1" class="text"><%=ModbusConnection.holdingRegisters[2]%></span></div>
        <progress value=<%=ModbusConnection.holdingRegisters[2]%> max="100" class="tanks-custom" id="tank-a"></progress>
        <div class="text">Tank-B : <span id="variable2" class="text"><%=ModbusConnection.holdingRegisters[3]%></span></div>
        <progress value=<%=ModbusConnection.holdingRegisters[3]%> max="100" class="tanks-custom" id="tank-b"></progress>
    </div>
<div id="arrow_btns">
...
<div id="modbus_part">
    <div class="modbus_status"> 정지중 </div>
